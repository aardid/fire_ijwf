...
# general imports
import os, shutil, warnings, gc, pickle, joblib
import numpy as np
...
# package imports
from fire.utilities import datetimeify, load_dataframe, save_dataframe
...
class ForecastModel(object):
    ...
    def __init__(self, window, overlap, look_forward, exclude_dates=[], station=None, ti=None, tf=None, 
        data_streams=['T','RH','W'], root=None, savefile_type='pkl', feature_root=None, 
        ...
        self.data = WeatherData(self.station, parent=self, data_dir=data_dir)
